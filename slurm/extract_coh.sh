#!/bin/bash
#SBATCH --job-name=pn26_coh
#SBATCH --partition=short
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G
#SBATCH --time=04:00:00
#SBATCH --array=0-31%24
#SBATCH --output=slurm/logs/coh_%A_%a.out
#SBATCH --error=slurm/logs/coh_%A_%a.out
set -o pipefail
...
python -u scripts/extract_coherence.py --data-folder "$DATA_FOLDER" --outdir "$OUTDIR" \
